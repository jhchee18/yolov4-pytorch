...
def fit_one_epoch(net,yolo_loss,epoch,epoch_size,epoch_size_val,gen,genval,Epoch,cuda):
    ...
    if Tensorboard:
        writer.add_scalar('Train_epoch_loss', total_loss/(iteration+1), epoch)
    net.eval()
    ...
    if Tensorboard:
        writer.add_scalar('Val_epoch_loss',val_loss / (epoch_size_val+1), epoch)
...
if __name__ == "__main__":
    ...
    classes_path = 'model_data/strawberryclass_from_camera.txt'
    #------------------------------------------------------#
    #   Yolov4的tricks应用
    ...
    #   获得图片路径和标签
    #----------------------------------------------------#
    annotation_path = 'strawberry_label_from_img.txt'
    #----------------------------------------------------------------------#
